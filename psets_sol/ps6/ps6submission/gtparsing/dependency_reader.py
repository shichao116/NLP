...
class DependencyReader():
    ...
    def loadInstances(self,filename,num_insts=None):
        instances = []
        inst = Instance()
    ...
    def load(self, language, num_insts):
        ...
        ### Load training data
        self.train_instances = self.loadInstances(path.join(base_deppars_dir, language+"_train.conll"),num_insts)
